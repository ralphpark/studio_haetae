...
### 제3조 (기술 스택 및 개발 환경)
- 사용 기술 스택을 명시: 프론트엔드(Next.js + TypeScript), 백엔드/DB(Supabase), 배포/인프라(Vercel)
- 모바일 프로젝트인 경우 Flutter, 자동화 프로젝트인 경우 n8n 명시
- 기술 스택 변경 시 양 당사자 서면 합의가 필요하며, 추가 비용이 발생할 수 있음을 명시
- 외부 API(결제, 소셜 로그인 등) 연동 시 해당 서비스의 장애는 갑의 책임 범위가 아님을 명시
